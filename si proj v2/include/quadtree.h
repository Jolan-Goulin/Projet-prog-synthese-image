...
Point3D milieuPts(Point3D p1, Point3D p2, int sizeX, int sizeY);
...
{   
    ...
    void initMapNode(Point3D Dupleft,Point3D Ddownleft,Point3D Dupright,Point3D Ddownright,int deep, int sizeX, int sizeY){
        ...
        if (this->data->mapX<=2 || this->data->mapY<=2){
            ...
            this->upleft->  initMapNode(this->data->Cupleft,   
                milieuPts(this->data->Cupleft, this->data->Cdownleft, sizeX, sizeY),
                milieuPts(this->data->Cupleft, this->data->Cupright, sizeX, sizeY),
                milieuPts(this->data->Cupleft, this->data->Cdownright, sizeX, sizeY), 
                deep+1,  sizeX,  sizeY);
            this->downleft->initMapNode(milieuPts(this->data->Cupleft, this->data->Cdownleft, sizeX, sizeY),
                this->data->Cdownleft,
                milieuPts(this->data->Cdownleft, this->data->Cupright, sizeX, sizeY),
                milieuPts(this->data->Cdownleft, this->data->Cdownright, sizeX, sizeY), 
                deep+1,  sizeX,  sizeY);
            this->upright-> initMapNode(milieuPts(this->data->Cupleft, this->data->Cupright, sizeX, sizeY),
                milieuPts(this->data->Cdownleft,this->data->Cupright, sizeX, sizeY),
                this->data->Cupright,
                milieuPts(this->data->Cupright, this->data->Cdownright, sizeX, sizeY), 
                deep+1,  sizeX,  sizeY);
            this->downright->initMapNode(milieuPts(this->data->Cupleft, this->data->Cdownright, sizeX, sizeY),
                milieuPts(this->data->Cdownleft, this->data->Cdownright, sizeX, sizeY),
                milieuPts(this->data->Cupright, this->data->Cdownright, sizeX, sizeY),
...
{    
    ...
    void initMap (vector<vector<int> > map, int mapX, int mapY){
        ...
        this->first->initMapNode(this->Cupleft,this->Cdownleft,this->Cupright,this->Cdownright,0, this->mapX, this->mapY);
    }
